...
class InstrumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instrumento" do
    assert_difference('Instrumento.count') do
      post instrumentos_url, params: { instrumento: { familia: @instrumento.familia, nome: @instrumento.nome } }
    end
  ...
  test "should update instrumento" do
    patch instrumento_url(@instrumento), params: { instrumento: { familia: @instrumento.familia, nome: @instrumento.nome } }

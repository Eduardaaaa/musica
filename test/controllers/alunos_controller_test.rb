...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { idade: @aluno.idade, instrumento: @aluno.instrumento, materia: @aluno.materia, nome: @aluno.nome, turno: @aluno.turno } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { idade: @aluno.idade, instrumento: @aluno.instrumento, materia: @aluno.materia, nome: @aluno.nome, turno: @aluno.turno } }
